...
- **Global Hotkeys** - Alt+Shift+Q (Start/Stop Record), Alt+Shift+W (Start/Stop Play)
...
- Press **Alt+Shift+Q** to stop recording and automatically save to a numbered file
...
- Press **Alt+Shift+W** at any time during replay to stop playback

### Option 3: Record and Replay Immediately
- Records actions, then immediately replays them
- Useful for quick testing
- Press **Alt+Shift+Q** to stop recording and auto-save, or **Alt+Shift+W** to stop playback during replay

## How It Works

1. **Recording**: The tool captures all mouse movements, clicks, scrolls, and keyboard presses with precise timing information.

2. **Replay**: The tool replays the recorded actions in the same sequence, maintaining the original timing between actions. You can stop playback at any time by pressing Alt+Shift+W.

3. **Auto-Save**: When you press Alt+Shift+Q during recording, the file is automatically saved with a numbered filename (e.g., `recorded_actions.json`, `recorded_actions_1.json`, etc.) to prevent overwriting existing files.
...
- **Hotkeys**: 
  - **Alt+Shift+Q**: Start recording (when not recording) or stop recording and auto-save (when recording)
  - **Alt+Shift+W**: Start replay (when not replaying) or stop playback (when replaying)
...
2. Press **Alt+Shift+Q** or click "Start Recording"
3. Perform your actions (move mouse, click, type, etc.)
4. Press **Alt+Shift+Q** again to stop recording and auto-save, or click "Stop Recording"
5. Click "Load Recording" to load a saved file
6. Set repeat count and delay, then press **Alt+Shift+W** or click "Start Replay"
7. Press **Alt+Shift+W** during replay to stop playback
...
3. Perform your actions (move mouse, click, type, etc.)
4. Press **Alt+Shift+Q** to stop recording and auto-save, or **ESC** to stop without auto-saving
5. If you used Alt+Shift+Q, the file is automatically saved with a numbered filename
6. Later, choose option 2 (Replay from file)
7. Load your saved file and specify how many times to replay
8. Press **Alt+Shift+W** at any time during replay to stop playback
